          ...
          <div className="CenterContent">
            <div className="CenterTxt animation-up" data-animate="slide-up">
             ...
             <div className="AppBtn Black">
               <Link href="/laplanta"><button>{t('sections.tech.button')}<Arrow_Icon /></button></Link>
             </div>
            </div>
          ...
          <div className="DivSection Left animation-up" data-animate="slide-up">
            ...
            <div className="SideTxt">
              ...
              <div className="AppBtn Brown">
                <Link href="/empresa"><button>{t('button.more')}<Arrow_Icon /></button></Link>
              </div>
            </div>
          ...
          <div className="DivSection Left animation-up" data-animate="slide-up">
            ...
            <div className="SideTxt">
              ...
              <div className="AppBtn Green">
                <Link href="/serveis"><button>{t('sections.services.button')}<Arrow_Icon /></button></Link>
              </div>
            </div>
          ...
          <div className="DivSection Left animation-up" data-animate="slide-up">
            ...
            <div className="SideTxt">
              ...
              <div className="AppBtn Blue">
                <Link href="/innovacio"><button>{t('sections.innovation.button')}<Arrow_Icon /></button></Link>
              </div>
            </div>
